...
class Ui_FirstTimeWindow(object):
    def setupUi(self, FirstTimeWindow):
        ...
        self.verticalLayout_4 = QVBoxLayout(FirstTimeWindow)
        ...
        self.tracks_totalsize_label = QLabel(self.groupBox_3)
        ...
        self.tracks_synccount_label = QLabel(self.groupBox_3)
        self.tracks_synccount_label.setObjectName(u"tracks_synccount_label")

        self.gridLayout.addWidget(self.tracks_synccount_label, 1, 0, 1, 2)

        self.tracks_copysize_label = QLabel(self.groupBox_3)
    ...
    def retranslateUi(self, FirstTimeWindow):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("FirstTimeWindow", u"Statistics", None))
        self.tracks_found_label.setText(QCoreApplication.translate("FirstTimeWindow", u"0 songs found", None))
        self.tracks_copycount_label.setText(QCoreApplication.translate("FirstTimeWindow", u"0 tracks to process", None))
        self.tracks_totalsize_label.setText(QCoreApplication.translate("FirstTimeWindow", u"0 MB total size", None))
        self.tracks_synccount_label.setText(QCoreApplication.translate("FirstTimeWindow", u"0 songs to track", None))
        self.tracks_copysize_label.setText(QCoreApplication.translate("FirstTimeWindow", u"0 MB to process", None))
